...
// Exports the component so App can import it and use it to display restaurant details
// Destructures restaurant from props, Now you can use restaurant.name, restaurant.rating, etc.
export function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  return (
    // Semantic HTML for a self-contained piece of content, Better than <div> for accessibility/SEO
